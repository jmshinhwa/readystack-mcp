...
const BENEFIT_ID = '153223e5-e9e2-474f-a1e7-79979fa2674a';   // s142 — this product's Polar benefit (s140 law: ask with benefit_id, or one key opens every product)
const BUY_URL = 'https://buy.polar.sh/polar_cl_qkyHZkQQW6eB0rXgrKfDGviLlVixnkbP42q8B3h7YrG';
const SLUG = 'mcp-config-guard';
