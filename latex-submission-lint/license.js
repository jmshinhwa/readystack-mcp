...
const BENEFIT_ID = 'b8d25493-257a-42d0-9535-e0ab110252a1';   // s142 — this product's Polar benefit (s140 law: ask with benefit_id, or one key opens every product)
const BUY_URL = 'https://buy.polar.sh/polar_cl_uLmgCBAZSFSJQ8Yvoose6IUOjSzo0hTMNwRg221VgCt';
const SLUG = 'latex-submission-lint';
